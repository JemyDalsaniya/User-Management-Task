		...
		<div class="container">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						<label for="fname">Full Name:</label> <input type="text"
							class="form-control text-width" id="fname"
							placeholder="Enter your name" /> <span id="fname-error"></span>
					</div>
				</div>
				<div class="col-md-6">
					...
					<div class="form-group">
						<label>Contact No:</label> <input type="text" class="form-control"
							id="phone-num" placeholder="Phone number" /> <span
							id="phonenum-error"></span>
					</div>
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="id1">Gender:</label><br /> <label
							...
							name="optionsRadios" id="id1" value="female" /> Female
						</label><br /> <label class="radio-inline radio-class"> <input
							type="radio" name="optionsRadios" id="id2" value="male" /> Male
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="pwd2">Confirm Password:</label> <input type="password"
							class="form-control text-width" id="pwd2"
							placeholder="Confirm-Password" /> <span id="confirm-error"></span>
					</div>
				</div>
			...
			<div class="row form-row">
				...
				<div class="col-md-6">
					<!-- image upload -->
					<div class="form-group">
						<label for="img">Select image:</label><br /> <input type="file"
							class="image_class" id="img" name="img"
							onchange="ImgPreview(event)" /><br /> <span id="image-error"></span><br />
										...
										<div class="row">
											<div class="col-sm-4">
												<div class="form-group">
													...
													<input type="text" id="address_line_one_0"
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<input type="text" id="address_line_two_0"
 ...
 -->				</div>
			...
			<div class="row btn-margin form-row">
				<div class="col-sm-1  submit_btn">
					...
					<a href="Userlogin.jsp" type="submit"
						class="btn btn-default btn-primary" onclick="submitbtn()">Submit</a>
				</div>
				<div class="col-sm-2">

					<a href="Userlogin.jsp" type="submit"
						class="btn btn-default btn-primary" onclick="submitbtn()">Back
						to login</a>
				</div>
			</div>
		</div>
