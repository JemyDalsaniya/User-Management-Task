    ...
    <div class="container">
        ...
        <form action="UserRegister" method="post" id="registration_form">
            ...
            <div class="row form-row ">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-width" id="name" name="name"
                ...
                <div class="col-md-6">
                    ...
                    <!-- Phone Number -->
                    <div class="form-group">
                        <label>Contact No:</label> <input type="text" class="form-control" id="contact"
            ...
            <div class="row form-row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-width" id="mail" placeholder="Email-id"
                            name="email" />
                ...
                <div class="col-md-6">
                    <!-- password -->
                    <div class="form-group">
                        <label for="pwd">Password:</label> <input type="password" class="form-control text-width"
            ...
            <div class="row form-row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="id1">Gender:</label><br /> <label class="radio-inline radio-class"> <input
                                type="radio" name="gender" id="id1" value="female" /> Female
                        </label><br /> <label class="radio-inline radio-class"> <input type="radio" name="gender"
                                id="id2" value="male" /> Male
                        </label><br /> <span id="radio-error"></span>
                    </div>
                </div>
                <!-- confirm password -->
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="pwd2">Confirm Password:</label> <input type="password"
                            class="form-control text-width" id="cpwd" name="cpassword" placeholder="Confirm-Password" />
            ...
            <div class="row form-row">
                <div class="col-md-6">
                    ...
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="check1" name="options" value="Sports"
                            checked> <label class="form-check-label" for="check1">Sports</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="check2" name="options" value="Study"> <label
                            class="form-check-label" for="check2">Study</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="check3" name="options" value="Dance"> <label
                            class="form-check-label">Dance</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="check3" name="options" value="Music"> <label
                            class="form-check-label">Music</label>
                    </div>
                    <span id="hobby-error"></span>
                </div>
                <div class="col-md-6">
                    <!-- image upload -->
                    <div class="form-group">
                        <label for="img">Select image:</label><br /> <input type="file" class="image_class" id="img"
                            name="img" onchange="ImgPreview(event)" /><br /> <span id="image-error"></span><br />
                        <div class="preview bg-image">
                            <img id="img-preview" class="img-file" />
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="control-label" for="city_0">City</label> <select
                                                    class="form-control" name="Address[0][state]" id="state_0"
                                                    style="height: auto;">
 ...
 -->
            ...
            <div class="row btn-margin form-row">
                <div class="col-sm-1  submit_btn">
                    ...
                    <input type="submit" class="btn btn-default btn-primary" onclick="submitbtn()" value="Submit">
                </div>
                <div class="col-sm-2">

                    <input type="submit" class="btn btn-default btn-primary" onclick="submitbtn()" value="Back
						to login">
                </div>
            </div>
        </form>
